package my.jhipster.application.repository;

import my.jhipster.application.MyHomeApp;
import my.jhipster.application.config.Constants;
import my.jhipster.application.config.audit.AuditEventConverter;
import my.jhipster.application.domain.PersistentAuditEvent;
...
import static my.jhipster.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
